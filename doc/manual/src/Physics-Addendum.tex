...
enhanced abstractions for biology, with the goal to derive the needed 'non-ordinary' laws of physics. The quotations are from \href{https://rcweb.dartmouth.edu/~mvdm/wiki/lib/exe/fetch.php?media=analysis:johnstonwu.pdf}{that book},
