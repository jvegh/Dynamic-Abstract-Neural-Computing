...
“from Hyperphysics by Rod Nave, Georgia State University". \copyright \href{hyperphysics.phy-astr.gsu.edu/hbase/}}
...
changes during the measurement (see section~\cite{sec:Calculating-ion's-speed}), or a "foreign" (not considered)
