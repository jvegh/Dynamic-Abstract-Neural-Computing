...
\subsection[Concepts]{Concepts of the play\label{Single-Concepts}}
...
\index{Coulomb's law}
Ohm, Kirchoff, Coulomb, Maxwell, and others. However, those abstractions have severe limitations when applied to living material; moreover, they mislead research in some aspects. It could be useful in its time of invention, at a very elementary level, but it surely cannot describe the details discovered
...
\subsubsection{The scene\label{sec:Single-Scene}}
...
\paragraph{Ion channels\label{sec:Single-IonChannels}}
...
\paragraph{Charged layers\label{sec:Single-ChargedLayers}}
...
\paragraph{Driving forces\label{sec:Single-Driving forces}}
