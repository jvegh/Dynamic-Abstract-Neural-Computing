...
Biology textbooks are full with wrong statements such as \textit{Ion channels cannot be coupled to an energy source to perform active transport,
...
requiring no expenditure of metabolic energy by the
channels. The direction and eventual equilibrium
for this flux are determined not by the channel itself,
but rather by the electrostatic and diffusional driving
forces across the membrane."\cite{PrinciplesNeuralScience:2013}, page 107. Not to mention that the last sentence directly contradicts to the previous one.
