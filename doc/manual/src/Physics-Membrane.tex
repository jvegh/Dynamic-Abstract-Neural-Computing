...
(unlike the creation of technical systems).
\index{law of motion}
...
\quotationbox{
"The crucial system in biology isn't a molecule or a molecular class whatsoever, but the interface created by biomolecules in water"~\cite{LivingSystemPhysics:2021}
}
