...
\includegraphics[width=.65\textwidth]{fig/RCLongWaveform.jpg}
		\caption{The output waveform of an integrator-type electric $RC$ circuit at a long ($8*\tau$) pulse width square wave input (see Eq.(https://www.electronics-tutorials.ws/) }
...
\fi
\caption{The green and red diagram lines are calculated for the clamping-on and clamping-off case. The dashed blue line models the case that the neuron is a purely electric system, as opposed to the case of clamping the axonal tube
