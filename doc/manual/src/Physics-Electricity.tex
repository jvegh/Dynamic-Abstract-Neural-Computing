...
neither is valid in unchanged form: constraints and physical/chemical additional forces are present, furthermore, the charges of the carriers are not
negligible compared to the charges that generate the field acting on the charges. Furthermore, since the carriers have mass, 
...
the discrete nature of charge carriers question marks differentiability of the corresponding functions, furthermore, 
the charge-mass dichotomy of ions the interpretation of 
\hyperlink{PartialDerivative}{partial derivatives}.
...
Ions, under the electrical/thermodynamic field (and maybe mechanixal constraints) accelerate to the Stokes-Einstein speed (see Eq.(\ref{eq:StokesSpeed}), move against a friction in the electrolyte.
