...
its validity for ionic solutions~\cite{VeghNon-ordinaryLaws:2025}. Classical science has limitation in describing nature;
...
pace, presenting a fascinating departure from traditional ('ordinary') physics.
\index{ordinary laws}
...
There are quasi-closed volumes is biological matter and the processes happen at the boundaries of the microscopic and macroscopic worlds, and we
...
The distributions, however, can be calculated for charge-less or size-less 'material points' only.
