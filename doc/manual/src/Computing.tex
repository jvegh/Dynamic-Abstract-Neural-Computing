...
\minitoc
\fi
\chapter[Computing with neurons]{Neural computing\label{ch:Computing}}
	\input{src/Computing-Foreword}
	\input{src/Computing-Introduction}
...
%see also @link MODELING_ACTION_POTENTIAL modeling of Action Potential@endlink.
	...
	\input{src/Computing-AP_Timing}
	\input{src/Computing-AP_Concept}
