% Concepts of science, "HH V2.0 book"
...
\quotationbox{
 “\textit{In thinking about the physical basis of the action potential perhaps the most important thing to do at the present moment is to consider whether there are any \textbf{\hypertarget{UnexplainedObservations}{unexplained observations}} which have been neglected in an attempt to make the experiments fit into a tidy pattern}”~\cite{HodgkinConduction:1964}, page 70.
}
...
(a problem of finite resources); furthermore, the concept of 'field' is slightly different from the classical one, see
below.
...
are implemented by short-range interaction (direct collisions). Although there are
...
The processes connect states and we need the corresponding
laws of motion to connect them. 
