...
For example, basic concepts such as the membrane potential and its regulation in resting and transient states, belong to chapter Physics,
...
The material has multiple layers. In addition to the sections intended to be understandable by everyone (i.e. primarily audience with a suitable physiological and neuroscience background), there are also panels (typically in another chapters) for those with the relevant background, containing the necessary \hyperlink{Mathematical panel~\ref{intro:MyMathematicsPanel}} and \hyperlink{Physical panel~\ref{intro:MyPhysicsPanel}} knowledge, which require at least the appropriate level of BSc knowledge to understand, but sometimes knowledge that goes beyond this, and sometimes
