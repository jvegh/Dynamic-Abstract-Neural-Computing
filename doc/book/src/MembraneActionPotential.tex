% This is the chapter 'Electricity, Action Potential' to the "Hodgkin-Huxley  neuron model V2.0 book"
% Last edited 2026.06.02

\section{The Action Potential\label{sec:ActionPotential}}
...
\subsection{The oscillator model\label{sec:OscillatorModel}}
...
\subsection{Mathematics of the ActionPotential\label{sec:MathematicsAP}}
