...
It happens despite Hodgkin's opinion about the \hyperlink{UnexplainedObservations}{unexplained observations}.
...
(a problem of finite resources); furthermore, the concept of 'field' is slightly different from the classical one, see section~\ref{sec:Physics-Fields}.  We must consider that the resources are finite. A main source of confusion is that the phenomena happen in a limited and closed region of space, and we study processes (in a period instead of a moment) where the environment is not "infinitely far" from the studied object,
the forces exerted on it belong to different disciplines, and \textit{the studied process interacts with its environment}. The boundaries of a closed volume
