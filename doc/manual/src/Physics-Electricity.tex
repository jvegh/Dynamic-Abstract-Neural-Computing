...
\else
\includegraphics[width=.32\textwidth]{fig/SolidResistance.png} & 
\includegraphics[width=.32\textwidth]{fig/IonicResistance.jpg} \\
\fi
\hline
...
%The ions traverse typically without collision, under the effect of an electric field. 
...
\indexit{Stokes-Einstein speed}, the voltage-, current- and pressure waves are synchronized, as observed. The different 
