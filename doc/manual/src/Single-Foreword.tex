...
on charge, given that the charges are ions instead of electrons. Furthermore, we shortly consider the mechanical (including thermodynamic), optical, etc. consequences.).
...
Similarly, the charge is the primary quantity when speaking about neural operations. 
...
electrical currents, then discuss how the cell handles the electrical charge. We note, however, that the different charge carrier (ions instead of electrons) needs care: the "slow current"
