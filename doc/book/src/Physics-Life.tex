% This is the chapter 'Physics-Life' to the "Hodgkin-Huxley neuron model V2.0 book"
% Last edited 2026.06.05

\section{Schrödinger on life\label{sec:Physics-SchrödingerOnLife}}
...
(for the interpretation of those points, see \hyperlink{phys:SchrödingerPoints}
{\textbf{Physics panel~\ref{phys:SchrödingerPoints}}})
\href{https://www.cambridge.org/core/books/abs/what-is-life/is-life-based-on-the-laws-of-physics/5BA8DE837F72FC4EEF70FE8470ADFE7B}{E.~Schrödinger: What is life?}\cite{Schrodinger:1992} @1944
}
...
{Schrödinger's points on living matter}
{
In his very accurately formulated question (see \hyperlink{phys:SchrödingerNonOrdinaryLaws}
{\textbf{Physics panel~\ref{phys:SchrödingerNonOrdinaryLaws}}}, 
