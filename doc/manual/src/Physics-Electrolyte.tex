...
an electrical potential wave~\cite{VeghMembranePotential:2026} that is measured as \gls{AP}. Only using  cross-disciplinary discussion (non-ordinary laws) enables understanding neuronal operation.  
