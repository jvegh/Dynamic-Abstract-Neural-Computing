...
\else
\section[Fogalmak]{Alapvető fogalmak\label{sec:PHYSICS_ELECTRICFundamental}}  
...
\else
\subsubsection{Ionáramok a sejtben\label{sec:Electricity-IonicCurrent}}
\fi
...
\else
\subsubsection[Sebesség]{Az áram sebesége\label{sec:Electricity-ion's-speed}}
