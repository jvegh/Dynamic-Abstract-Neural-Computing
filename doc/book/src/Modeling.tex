...
\chapter[Modeling]{Modeling for neurons\label{ch:Modeling}}
...
\section[The V2.0 model]{The V2.0 modell in a nutshell\label{sec:Modell-Nutshell}}
...
In our non-disciplinary science-based model (the 'abstract physical neuron', as we call it), a neuron (highly simplified) is an elastic sphere with two lipid layers (membrane), a similarly elastic insulating output tube (axon), and an incompressible, partially ionized electrolyte fluid with different compositions and concentrations inside and outside.
...
\subsection[Differences to V1.0]
{Essential differences to the V1.0 modell\label{sec:Modell-Differences}}