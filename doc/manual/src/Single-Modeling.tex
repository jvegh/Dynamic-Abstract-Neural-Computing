...
]{Operation of our model in a nutshell\label{sec:Single-Nutshell}}
...
mechanism is \textit{bioelectric} (instead of purely an electric field
...
The forces exerting on ions in a disciplinary way are falsified 
...
Furthermore, as our force analyzis suggests, the ions motion 
is an interference between the longitudinal thermodynamic oscillation of elastic origin
