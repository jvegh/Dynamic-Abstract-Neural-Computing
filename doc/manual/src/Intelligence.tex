...
Although it is challenging both to list the crucial differences between technological components attempting to mimic a biological component and to separate the
\gls{HW}
and \gls{SW}
